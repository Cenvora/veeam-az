...
T = TypeVar("T", bound="PageOfOAuth2AccountLinks")


@_attrs_define
class PageOfOAuth2AccountLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_o_auth_2_account_links = cls()
        ...
        page_of_o_auth_2_account_links.additional_properties = additional_properties
        return page_of_o_auth_2_account_links
