...
T = TypeVar("T", bound="WorkerNetworkConfigurationDeletionResult")


@_attrs_define
class WorkerNetworkConfigurationDeletionResult:
    """Result of the worker configuration deletion.

    Attributes:
        busy_workers_exists (bool | Unset): Defines whether any workers with the removing configuration are currently
            running.
        remaining_network_interface_ids (list[str] | None | Unset): IDs of remaining network interfaces.
        deletion_successfull (bool | Unset): Defines whether the worker configuration was removed successfully.
        virtual_network_name (None | str | Unset): Name of the virtual network where the worker resides.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        worker_network_configuration_deletion_result = cls(
        ...
        return worker_network_configuration_deletion_result
