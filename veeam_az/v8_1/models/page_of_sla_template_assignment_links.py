...
T = TypeVar("T", bound="PageOfSlaTemplateAssignmentLinks")


@_attrs_define
class PageOfSlaTemplateAssignmentLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_sla_template_assignment_links = cls()
        ...
        page_of_sla_template_assignment_links.additional_properties = additional_properties
        return page_of_sla_template_assignment_links
