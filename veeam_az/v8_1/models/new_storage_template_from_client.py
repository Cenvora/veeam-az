...
T = TypeVar("T", bound="NewStorageTemplateFromClient")


@_attrs_define
class NewStorageTemplateFromClient:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_storage_template_from_client = cls(
            name=name,
            description=description,
            storage_configuration=storage_configuration,
        )

        new_storage_template_from_client.additional_properties = d
        return new_storage_template_from_client
