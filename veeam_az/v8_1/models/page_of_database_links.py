...
T = TypeVar("T", bound="PageOfDatabaseLinks")


@_attrs_define
class PageOfDatabaseLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_database_links.additional_properties = additional_properties
        return page_of_database_links
