...
T = TypeVar("T", bound="AsyncOperationOfPageOfVirtualMachineLinks")


@_attrs_define
class AsyncOperationOfPageOfVirtualMachineLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_page_of_virtual_machine_links = cls()
        ...
        async_operation_of_page_of_virtual_machine_links.additional_properties = additional_properties
        return async_operation_of_page_of_virtual_machine_links
