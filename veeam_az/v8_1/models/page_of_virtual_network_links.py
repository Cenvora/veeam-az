...
T = TypeVar("T", bound="PageOfVirtualNetworkLinks")


@_attrs_define
class PageOfVirtualNetworkLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_virtual_network_links = cls()
        ...
        page_of_virtual_network_links.additional_properties = additional_properties
        return page_of_virtual_network_links
