...
T = TypeVar("T", bound="AsyncOperationOfNullableBooleanLinks")


@_attrs_define
class AsyncOperationOfNullableBooleanLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_nullable_boolean_links = cls()
        ...
        async_operation_of_nullable_boolean_links.additional_properties = additional_properties
        return async_operation_of_nullable_boolean_links
