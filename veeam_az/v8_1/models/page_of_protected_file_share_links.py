...
T = TypeVar("T", bound="PageOfProtectedFileShareLinks")


@_attrs_define
class PageOfProtectedFileShareLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_protected_file_share_links = cls()
        ...
        page_of_protected_file_share_links.additional_properties = additional_properties
        return page_of_protected_file_share_links
