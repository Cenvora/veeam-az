...
T = TypeVar("T", bound="CosmosDbOptions")
...
class CosmosDbOptions:
    ...
    Attributes:
        ...
        service_account_id (str | Unset): Returns only Cosmos DB accounts to which a service account with the specified
            ID has access.
        ...
        protection_status (list[ProtectionStatus] | None | Unset): Returns only Cosmos DB accounts with the specified
            protection statuses.
        backup_destination (list[CosmosBackupDestinationFilterOptions] | None | Unset): Returns only Cosmos DB accounts
            with the specified backup types.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_backup_destination(data: object) -> list[CosmosBackupDestinationFilterOptions] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for backup_destination_type_0_item_data in _backup_destination_type_0:
                    backup_destination_type_0_item = CosmosBackupDestinationFilterOptions(
                ...
                pass
            return cast(list[CosmosBackupDestinationFilterOptions] | None | Unset, data)

        backup_destination = _parse_backup_destination(d.pop("backupDestination", UNSET))

        cosmos_db_options = cls(
