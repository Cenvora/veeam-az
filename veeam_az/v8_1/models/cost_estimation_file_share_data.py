...
if TYPE_CHECKING:
    from ..models.cost_estimation_file_share_assumptions import CostEstimationFileShareAssumptions
    from ..models.cost_estimation_file_share_totals import CostEstimationFileShareTotals
    from ..models.cost_estimation_warning_group import CostEstimationWarningGroup


T = TypeVar("T", bound="CostEstimationFileShareData")


@_attrs_define
class CostEstimationFileShareData:
    """Information on total estimated costs per month, assumptions and warnings.

    Attributes:
        totals (CostEstimationFileShareTotals | Unset): Information on the cost estimation totals.
        assumptions (CostEstimationFileShareAssumptions | Unset): Assumptions used to calculate the cost.
        warning_groups (list[CostEstimationWarningGroup] | None | Unset): Information on the warning groups for the
            backup policy estimated cost.
        currency_iso_code (None | str | Unset): ISO code of the used currency.
    """

    totals: CostEstimationFileShareTotals | Unset = UNSET
    assumptions: CostEstimationFileShareAssumptions | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        totals: CostEstimationFileShareTotals | Unset
        if isinstance(_totals, Unset):
            totals = UNSET
        else:
            totals = CostEstimationFileShareTotals.from_dict(_totals)

        _assumptions = d.pop("assumptions", UNSET)
        assumptions: CostEstimationFileShareAssumptions | Unset
        if isinstance(_assumptions, Unset):
            assumptions = UNSET
        else:
            assumptions = CostEstimationFileShareAssumptions.from_dict(_assumptions)
        ...
        cost_estimation_file_share_data = cls(
            totals=totals,
        ...
        return cost_estimation_file_share_data
