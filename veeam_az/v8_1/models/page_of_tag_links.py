...
T = TypeVar("T", bound="PageOfTagLinks")


@_attrs_define
class PageOfTagLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_tag_links.additional_properties = additional_properties
        return page_of_tag_links
