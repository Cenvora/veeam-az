...
T = TypeVar("T", bound="PageOfRepositoryLinks")


@_attrs_define
class PageOfRepositoryLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_repository_links.additional_properties = additional_properties
        return page_of_repository_links
