...
if TYPE_CHECKING:
    from ..models.page_of_tag_links import PageOfTagLinks
    from ..models.tag import Tag


T = TypeVar("T", bound="PageOfTag")
...
class PageOfTag:
    ...
    Attributes:
        ...
        field_links (PageOfTagLinks | Unset): URLs of operations where the properties obtained in the response can be
            used as an input.
        results (list[Tag] | Unset): Results of the performed operation.
    """

    offset: int
    limit: int
    total_count: int | None | Unset = UNSET
    field_links: PageOfTagLinks | Unset = UNSET
    results: list[Tag] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_links: PageOfTagLinks | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = PageOfTagLinks.from_dict(_field_links)
        ...
        page_of_tag.additional_properties = d
        return page_of_tag
