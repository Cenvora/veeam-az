...
T = TypeVar("T", bound="PageOfProtectedVirtualMachineLinks")


@_attrs_define
class PageOfProtectedVirtualMachineLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_protected_virtual_machine_links = cls()
        ...
        page_of_protected_virtual_machine_links.additional_properties = additional_properties
        return page_of_protected_virtual_machine_links
