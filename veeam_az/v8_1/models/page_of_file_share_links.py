...
T = TypeVar("T", bound="PageOfFileShareLinks")


@_attrs_define
class PageOfFileShareLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_file_share_links.additional_properties = additional_properties
        return page_of_file_share_links
