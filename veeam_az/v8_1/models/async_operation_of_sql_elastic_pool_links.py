...
T = TypeVar("T", bound="AsyncOperationOfSqlElasticPoolLinks")


@_attrs_define
class AsyncOperationOfSqlElasticPoolLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_sql_elastic_pool_links = cls()
        ...
        async_operation_of_sql_elastic_pool_links.additional_properties = additional_properties
        return async_operation_of_sql_elastic_pool_links
