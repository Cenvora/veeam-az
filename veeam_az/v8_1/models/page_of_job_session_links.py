...
T = TypeVar("T", bound="PageOfJobSessionLinks")


@_attrs_define
class PageOfJobSessionLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_job_session_links.additional_properties = additional_properties
        return page_of_job_session_links
