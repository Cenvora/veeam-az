...
T = TypeVar("T", bound="PageOfSlaSessionReportRowLinks")


@_attrs_define
class PageOfSlaSessionReportRowLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_sla_session_report_row_links = cls()
        ...
        page_of_sla_session_report_row_links.additional_properties = additional_properties
        return page_of_sla_session_report_row_links
