...
T = TypeVar("T", bound="PageOfVirtualMachineRestorePointLinks")


@_attrs_define
class PageOfVirtualMachineRestorePointLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_virtual_machine_restore_point_links = cls()
        ...
        page_of_virtual_machine_restore_point_links.additional_properties = additional_properties
        return page_of_virtual_machine_restore_point_links
