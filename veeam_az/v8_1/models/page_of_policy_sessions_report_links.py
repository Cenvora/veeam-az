...
T = TypeVar("T", bound="PageOfPolicySessionsReportLinks")


@_attrs_define
class PageOfPolicySessionsReportLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_policy_sessions_report_links = cls()
        ...
        page_of_policy_sessions_report_links.additional_properties = additional_properties
        return page_of_policy_sessions_report_links
