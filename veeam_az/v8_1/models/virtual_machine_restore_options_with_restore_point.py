...
T = TypeVar("T", bound="VirtualMachineRestoreOptionsWithRestorePoint")


@_attrs_define
class VirtualMachineRestoreOptionsWithRestorePoint:
    """Specifies Azure VM restore options.

    Attributes:
        reason (str): Specifies a reason for performing the restore operation.
        restore_point_id (UUID | Unset): Specifies the system ID assigned in the Veeam Backup for Microsoft Azure REST
            API to a restore point.
        service_account_id (None | str | Unset): Specifies the system ID assigned in the Veeam Backup for Microsoft
            Azure REST API to a service account whose permissions will be used to perform the restore operation.
        ...
        start_vm_after_restore (bool | Unset): Defines whether to start the restored VM after the restore operation
            completes.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        virtual_machine_restore_options_with_restore_point = cls(
            reason=reason,
        ...
        return virtual_machine_restore_options_with_restore_point
