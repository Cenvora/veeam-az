...
T = TypeVar("T", bound="AdGroupSettings")


@_attrs_define
class AdGroupSettings:
    r"""Specifies the settings of a Microsoft Entra group.

    Attributes:
        group_id_to_add (None | str | Unset): Specifies the system ID assigned in the Veeam Backup for Microsoft Azure
            REST API to a Microsoft Entra group to which the account will be added.
        group_name_to_add (None | str | Unset): Specifies the name of the Microsoft Entra group to which the account
            will be added.
        group_id_to_remove (None | str | Unset): \[Applies if an existing service account is being added] Specifies the
            system ID assigned in the Veeam Backup for Microsoft Azure REST API to a Microsoft Entra group from which the
            account will be moved to *groupIdToAdd*.
    """
