...
T = TypeVar("T", bound="AsyncOperationOfPageOfStorageAccountLinks")


@_attrs_define
class AsyncOperationOfPageOfStorageAccountLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_page_of_storage_account_links = cls()
        ...
        async_operation_of_page_of_storage_account_links.additional_properties = additional_properties
        return async_operation_of_page_of_storage_account_links
