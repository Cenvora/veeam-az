...
T = TypeVar("T", bound="PageOfVirtualMachineLinks")


@_attrs_define
class PageOfVirtualMachineLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_virtual_machine_links = cls()
        ...
        page_of_virtual_machine_links.additional_properties = additional_properties
        return page_of_virtual_machine_links
