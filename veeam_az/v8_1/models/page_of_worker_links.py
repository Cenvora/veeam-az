...
T = TypeVar("T", bound="PageOfWorkerLinks")


@_attrs_define
class PageOfWorkerLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_worker_links.additional_properties = additional_properties
        return page_of_worker_links
