...
T = TypeVar("T", bound="BackupRepositoryConfigurationFromClient")


@_attrs_define
class BackupRepositoryConfigurationFromClient:
    """Specifies target locations where backups will be stored.

    Attributes:
        default_repository_id (UUID | Unset): Specifies a system ID assigned to the default backup repository in the
            Veeam Backup for Microsoft Azure REST API.
        items (list[RepositoryConfigurationItemFromClient] | Unset): Specifies region-specific backup repository
            settings. If not provided, the default backup repository will be used for all regions.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_repository_configuration_from_client = cls(
            default_repository_id=default_repository_id,
            items=items,
        )

        backup_repository_configuration_from_client.additional_properties = d
        return backup_repository_configuration_from_client
