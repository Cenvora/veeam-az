...
T = TypeVar("T", bound="SqlServerForStandardAccount")


@_attrs_define
class SqlServerForStandardAccount:
    """
    Attributes:
        id (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sql_server_for_standard_account = cls(
            id=id,
        ...
        return sql_server_for_standard_account
