...
T = TypeVar("T", bound="PageOfSqlPolicyBackupItemLinks")


@_attrs_define
class PageOfSqlPolicyBackupItemLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_sql_policy_backup_item_links = cls()
        ...
        page_of_sql_policy_backup_item_links.additional_properties = additional_properties
        return page_of_sql_policy_backup_item_links
