...
T = TypeVar("T", bound="FileShareOptions")


@_attrs_define
class FileShareOptions:
    """
    Attributes:
        ...
        service_account_id (str | Unset): Returns only file shares to which a service account ith the specified ID has
            access.
