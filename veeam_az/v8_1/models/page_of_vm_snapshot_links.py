...
T = TypeVar("T", bound="PageOfVmSnapshotLinks")


@_attrs_define
class PageOfVmSnapshotLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_vm_snapshot_links.additional_properties = additional_properties
        return page_of_vm_snapshot_links
