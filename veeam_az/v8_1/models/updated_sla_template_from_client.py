...
T = TypeVar("T", bound="UpdatedSlaTemplateFromClient")


@_attrs_define
class UpdatedSlaTemplateFromClient:
    """
    Attributes:
        name (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        updated_sla_template_from_client = cls(
            name=name,
            description=description,
            sla_configuration=sla_configuration,
        )

        updated_sla_template_from_client.additional_properties = d
        return updated_sla_template_from_client
