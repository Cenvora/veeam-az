...
T = TypeVar("T", bound="MonthlyCosmosDbSchedule")


@_attrs_define
class MonthlyCosmosDbSchedule:
    r"""/[Applies only to backup policies that have the *Backup to repository* option enabled] Specifies monthly schedule
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        monthly_cosmos_db_schedule = cls(
        ...
        return monthly_cosmos_db_schedule
