...
T = TypeVar("T", bound="PageOfSqlElasticPoolLinks")


@_attrs_define
class PageOfSqlElasticPoolLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_sql_elastic_pool_links = cls()
        ...
        page_of_sql_elastic_pool_links.additional_properties = additional_properties
        return page_of_sql_elastic_pool_links
