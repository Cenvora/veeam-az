...
T = TypeVar("T", bound="UpdatedFileSharePolicyFromClient")


@_attrs_define
class UpdatedFileSharePolicyFromClient:
    r"""
    Attributes:
        regions (list[PolicyRegionFromClient]): Specifies a list of regions where the backed-up file shares reside.
        ...
        service_account_id (None | Unset | UUID): Specifies the system ID assigned in the Veeam Backup for Microsoft
            Azure REST API to the service account whose permissions will be used to perform backups of Azure file shares.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        updated_file_share_policy_from_client = cls(
            regions=regions,
            name=name,
        ...
        return updated_file_share_policy_from_client
