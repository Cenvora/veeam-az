...
T = TypeVar("T", bound="PageOfKeyVaultKeyLinks")


@_attrs_define
class PageOfKeyVaultKeyLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_key_vault_key_links = cls()
        ...
        page_of_key_vault_key_links.additional_properties = additional_properties
        return page_of_key_vault_key_links
