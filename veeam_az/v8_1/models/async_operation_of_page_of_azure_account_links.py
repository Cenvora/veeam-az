...
T = TypeVar("T", bound="AsyncOperationOfPageOfAzureAccountLinks")


@_attrs_define
class AsyncOperationOfPageOfAzureAccountLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_page_of_azure_account_links = cls()
        ...
        async_operation_of_page_of_azure_account_links.additional_properties = additional_properties
        return async_operation_of_page_of_azure_account_links
