...
T = TypeVar("T", bound="PageOfJobSessionReportLinks")


@_attrs_define
class PageOfJobSessionReportLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_job_session_report_links = cls()
        ...
        page_of_job_session_report_links.additional_properties = additional_properties
        return page_of_job_session_report_links
