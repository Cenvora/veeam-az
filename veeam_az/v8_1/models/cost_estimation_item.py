...
T = TypeVar("T", bound="CostEstimationItem")


@_attrs_define
class CostEstimationItem:
    """Information on cost estimation of each protected resource.

    Attributes:
        protected_item_hash_id (None | str | Unset): Internal ID assigned to the protected resource in the Veeam Backup
        ...
        backup_cost (CostEstimationItemCostsData | Unset): Information on the cost estimation for Azure services used by
            the backup policy.
        archive_cost (CostEstimationItemCostsData | Unset): Information on the cost estimation for Azure services used
            by the backup policy.
    ...
    archive_cost: CostEstimationItemCostsData | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        archive_cost: dict[str, Any] | Unset = UNSET
        if not isinstance(self.archive_cost, Unset):
            archive_cost = self.archive_cost.to_dict()
        ...
        if archive_cost is not UNSET:
            field_dict["archiveCost"] = archive_cost
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _archive_cost = d.pop("archiveCost", UNSET)
        archive_cost: CostEstimationItemCostsData | Unset
        if isinstance(_archive_cost, Unset):
            archive_cost = UNSET
        else:
            archive_cost = CostEstimationItemCostsData.from_dict(_archive_cost)
