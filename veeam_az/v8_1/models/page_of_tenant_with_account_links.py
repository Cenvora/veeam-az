...
T = TypeVar("T", bound="PageOfTenantWithAccountLinks")


@_attrs_define
class PageOfTenantWithAccountLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_tenant_with_account_links = cls()
        ...
        page_of_tenant_with_account_links.additional_properties = additional_properties
        return page_of_tenant_with_account_links
