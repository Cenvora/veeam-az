...
T = TypeVar("T", bound="AsyncOperationOfAdGroupListingResultLinks")


@_attrs_define
class AsyncOperationOfAdGroupListingResultLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_ad_group_listing_result_links = cls()
        ...
        async_operation_of_ad_group_listing_result_links.additional_properties = additional_properties
        return async_operation_of_ad_group_listing_result_links
