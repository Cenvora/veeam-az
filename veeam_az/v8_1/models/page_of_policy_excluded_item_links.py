...
T = TypeVar("T", bound="PageOfPolicyExcludedItemLinks")


@_attrs_define
class PageOfPolicyExcludedItemLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_policy_excluded_item_links = cls()
        ...
        page_of_policy_excluded_item_links.additional_properties = additional_properties
        return page_of_policy_excluded_item_links
