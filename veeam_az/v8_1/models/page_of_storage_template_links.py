...
T = TypeVar("T", bound="PageOfStorageTemplateLinks")


@_attrs_define
class PageOfStorageTemplateLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_storage_template_links = cls()
        ...
        page_of_storage_template_links.additional_properties = additional_properties
        return page_of_storage_template_links
