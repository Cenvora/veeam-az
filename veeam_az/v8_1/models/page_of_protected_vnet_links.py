...
T = TypeVar("T", bound="PageOfProtectedVnetLinks")


@_attrs_define
class PageOfProtectedVnetLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_protected_vnet_links = cls()
        ...
        page_of_protected_vnet_links.additional_properties = additional_properties
        return page_of_protected_vnet_links
