...
T = TypeVar("T", bound="PageOfVmProtectionPolicyLinks")


@_attrs_define
class PageOfVmProtectionPolicyLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_vm_protection_policy_links = cls()
        ...
        page_of_vm_protection_policy_links.additional_properties = additional_properties
        return page_of_vm_protection_policy_links
