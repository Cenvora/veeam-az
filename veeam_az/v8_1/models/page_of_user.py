...
if TYPE_CHECKING:
    from ..models.page_of_user_links import PageOfUserLinks
...
class PageOfUser:
    ...
    Attributes:
        ...
        field_links (PageOfUserLinks | Unset): URLs of operations where the properties obtained in the response can be
            used as an input.
        results (list[User] | Unset): Results of the performed operation.
    """

    offset: int
    limit: int
    total_count: int | None | Unset = UNSET
    field_links: PageOfUserLinks | Unset = UNSET
    results: list[User] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_links: PageOfUserLinks | Unset
        if isinstance(_field_links, Unset):
            field_links = UNSET
        else:
            field_links = PageOfUserLinks.from_dict(_field_links)
