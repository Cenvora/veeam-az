...
T = TypeVar("T", bound="PageOfRestoredDatabaseLinks")


@_attrs_define
class PageOfRestoredDatabaseLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_restored_database_links = cls()
        ...
        page_of_restored_database_links.additional_properties = additional_properties
        return page_of_restored_database_links
