...
T = TypeVar("T", bound="DailyFileShareSchedule")


@_attrs_define
class DailyFileShareSchedule:
    r"""Specifies daily schedule settings for the backup policy.
    ...
    Attributes:
        ...
        runs_per_hour (int | None | Unset): Number of times for the backup policy to run within an hour. The minimum
            value is 1.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return daily_file_share_schedule
