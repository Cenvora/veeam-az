...
T = TypeVar("T", bound="AsyncOperationOfPageOfCosmosDbAccountLinks")


@_attrs_define
class AsyncOperationOfPageOfCosmosDbAccountLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_page_of_cosmos_db_account_links = cls()
        ...
        async_operation_of_page_of_cosmos_db_account_links.additional_properties = additional_properties
        return async_operation_of_page_of_cosmos_db_account_links
