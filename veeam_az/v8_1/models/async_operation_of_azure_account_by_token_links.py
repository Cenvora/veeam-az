...
T = TypeVar("T", bound="AsyncOperationOfAzureAccountByTokenLinks")


@_attrs_define
class AsyncOperationOfAzureAccountByTokenLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_azure_account_by_token_links = cls()
        ...
        async_operation_of_azure_account_by_token_links.additional_properties = additional_properties
        return async_operation_of_azure_account_by_token_links
