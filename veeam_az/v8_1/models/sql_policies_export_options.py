...
T = TypeVar("T", bound="SqlPoliciesExportOptions")


@_attrs_define
class SqlPoliciesExportOptions:
    """
    Attributes:
        policy_ids (list[UUID] | None | Unset): Specifies the system IDs assigned in the Veeam Backup for Microsoft
            Azure REST API to the SQL backup policies whose data will be exported.
        policy_name (None | str | Unset): Exports only data on the backup policy with the specified name.
        last_job_status (list[JobStatus] | None | Unset): Exports only data on the backup policies with the specified
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sql_policies_export_options = cls(
        ...
        return sql_policies_export_options
