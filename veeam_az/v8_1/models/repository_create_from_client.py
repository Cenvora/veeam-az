...
T = TypeVar("T", bound="RepositoryCreateFromClient")


@_attrs_define
class RepositoryCreateFromClient:
    r"""Specifies information on a backup repository.
    ...
    Attributes:
        ...
        azure_account_id (str): Specifies the system ID assigned in the Veeam Backup for Microsoft Azure REST API to a
            service account whose permissions are used to connect to a repository.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        repository_create_from_client = cls(
        ...
        return repository_create_from_client
