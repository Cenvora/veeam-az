...
T = TypeVar("T", bound="AsyncOperationOfPageOfProtectedDatabaseLinks")


@_attrs_define
class AsyncOperationOfPageOfProtectedDatabaseLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_page_of_protected_database_links = cls()
        ...
        async_operation_of_page_of_protected_database_links.additional_properties = additional_properties
        return async_operation_of_page_of_protected_database_links
