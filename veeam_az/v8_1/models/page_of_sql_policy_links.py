...
T = TypeVar("T", bound="PageOfSqlPolicyLinks")


@_attrs_define
class PageOfSqlPolicyLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_sql_policy_links.additional_properties = additional_properties
        return page_of_sql_policy_links
