...
T = TypeVar("T", bound="ManualSnapshotSettings")


@_attrs_define
class ManualSnapshotSettings:
    """Specifies Azure tags that will be assigned to the snapshots.

    Attributes:
        additional_tags (list[TagFromClient] | None | Unset): Specifies additional Azure tags that will be assigned to
            the snapshots.
        copy_original_tags (bool | Unset): Defines whether to assign to the snapshots tags of virtual disks attached to
            processed Azure VMs. The default value is **true**.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        manual_snapshot_settings = cls(
            additional_tags=additional_tags,
            copy_original_tags=copy_original_tags,
        )

        return manual_snapshot_settings
