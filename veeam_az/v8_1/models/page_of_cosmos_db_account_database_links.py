...
T = TypeVar("T", bound="PageOfCosmosDbAccountDatabaseLinks")


@_attrs_define
class PageOfCosmosDbAccountDatabaseLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_cosmos_db_account_database_links = cls()
        ...
        page_of_cosmos_db_account_database_links.additional_properties = additional_properties
        return page_of_cosmos_db_account_database_links
