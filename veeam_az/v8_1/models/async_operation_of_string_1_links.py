...
T = TypeVar("T", bound="AsyncOperationOfString1Links")


@_attrs_define
class AsyncOperationOfString1Links:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_string_1_links = cls()
        ...
        async_operation_of_string_1_links.additional_properties = additional_properties
        return async_operation_of_string_1_links
