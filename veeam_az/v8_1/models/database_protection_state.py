...
if TYPE_CHECKING:
    from ..models.sql_policy_link import SqlPolicyLink
    from ..models.sql_restore_point_link import SqlRestorePointLink


T = TypeVar("T", bound="DatabaseProtectionState")


@_attrs_define
class DatabaseProtectionState:
    """
    Attributes:
        protection_status (ProtectionStatus | Unset):
        repositories (list[str] | None | Unset):
        destinations (list[SqlBackupDestination] | None | Unset):
        policy_name (None | str | Unset):
        policies (list[SqlPolicyLink] | None | Unset):
        restore_points (list[SqlRestorePointLink] | None | Unset):
    ...
    destinations: list[SqlBackupDestination] | None | Unset = UNSET
    policy_name: None | str | Unset = UNSET
    policies: list[SqlPolicyLink] | None | Unset = UNSET
    restore_points: list[SqlRestorePointLink] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_destinations(data: object) -> list[SqlBackupDestination] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for destinations_type_0_item_data in _destinations_type_0:
                    destinations_type_0_item = SqlBackupDestination(destinations_type_0_item_data)
                ...
                pass
            return cast(list[SqlBackupDestination] | None | Unset, data)
        ...
        def _parse_policies(data: object) -> list[SqlPolicyLink] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for policies_type_0_item_data in _policies_type_0:
                    policies_type_0_item = SqlPolicyLink.from_dict(policies_type_0_item_data)
                ...
                pass
            return cast(list[SqlPolicyLink] | None | Unset, data)

        policies = _parse_policies(d.pop("policies", UNSET))

        def _parse_restore_points(data: object) -> list[SqlRestorePointLink] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for restore_points_type_0_item_data in _restore_points_type_0:
                    restore_points_type_0_item = SqlRestorePointLink.from_dict(restore_points_type_0_item_data)
                ...
                pass
            return cast(list[SqlRestorePointLink] | None | Unset, data)
        ...
        return database_protection_state
