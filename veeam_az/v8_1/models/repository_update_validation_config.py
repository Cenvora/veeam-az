...
T = TypeVar("T", bound="RepositoryUpdateValidationConfig")


@_attrs_define
class RepositoryUpdateValidationConfig:
    """
    Attributes:
        steps (list[RepositoryValidationStep] | None | Unset): Specifies the steps of the backup repository settings
            validation.
        repository (RepositoryUpdateFromClientWithKeyVault | Unset):
    """

    steps: list[RepositoryValidationStep] | None | Unset = UNSET
    repository: RepositoryUpdateFromClientWithKeyVault | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_repository, Unset):
            ...
            repository = RepositoryUpdateFromClientWithKeyVault.from_dict(_repository)

        repository_update_validation_config = cls(
            steps=steps,
            repository=repository,
        )

        return repository_update_validation_config
