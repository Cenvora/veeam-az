...
T = TypeVar("T", bound="PageOfWorkerNetworkConfigurationLinks")


@_attrs_define
class PageOfWorkerNetworkConfigurationLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_worker_network_configuration_links = cls()
        ...
        page_of_worker_network_configuration_links.additional_properties = additional_properties
        return page_of_worker_network_configuration_links
