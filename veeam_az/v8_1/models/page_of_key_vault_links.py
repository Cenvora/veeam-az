...
T = TypeVar("T", bound="PageOfKeyVaultLinks")


@_attrs_define
class PageOfKeyVaultLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_key_vault_links.additional_properties = additional_properties
        return page_of_key_vault_links
