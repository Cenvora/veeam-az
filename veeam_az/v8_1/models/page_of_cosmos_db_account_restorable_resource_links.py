...
T = TypeVar("T", bound="PageOfCosmosDbAccountRestorableResourceLinks")


@_attrs_define
class PageOfCosmosDbAccountRestorableResourceLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_cosmos_db_account_restorable_resource_links = cls()
        ...
        page_of_cosmos_db_account_restorable_resource_links.additional_properties = additional_properties
        return page_of_cosmos_db_account_restorable_resource_links
