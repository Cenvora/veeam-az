...
T = TypeVar("T", bound="PageOfProtectedDatabaseLinks")


@_attrs_define
class PageOfProtectedDatabaseLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_protected_database_links = cls()
        ...
        page_of_protected_database_links.additional_properties = additional_properties
        return page_of_protected_database_links
