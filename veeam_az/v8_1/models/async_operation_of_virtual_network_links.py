...
T = TypeVar("T", bound="AsyncOperationOfVirtualNetworkLinks")


@_attrs_define
class AsyncOperationOfVirtualNetworkLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_virtual_network_links = cls()
        ...
        async_operation_of_virtual_network_links.additional_properties = additional_properties
        return async_operation_of_virtual_network_links
