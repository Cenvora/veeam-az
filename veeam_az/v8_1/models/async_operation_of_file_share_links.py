...
T = TypeVar("T", bound="AsyncOperationOfFileShareLinks")


@_attrs_define
class AsyncOperationOfFileShareLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_file_share_links = cls()
        ...
        async_operation_of_file_share_links.additional_properties = additional_properties
        return async_operation_of_file_share_links
