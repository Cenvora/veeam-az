...
T = TypeVar("T", bound="PageOfAzureAccountLinks")


@_attrs_define
class PageOfAzureAccountLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_azure_account_links = cls()
        ...
        page_of_azure_account_links.additional_properties = additional_properties
        return page_of_azure_account_links
