...
T = TypeVar("T", bound="StorageTemplateAssignment")


@_attrs_define
class StorageTemplateAssignment:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        storage_template_assignment = cls(
            protection_policy_id=protection_policy_id,
            protection_policy_name=protection_policy_name,
        )

        storage_template_assignment.additional_properties = d
        return storage_template_assignment
