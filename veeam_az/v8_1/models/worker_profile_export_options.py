...
T = TypeVar("T", bound="WorkerProfileExportOptions")


@_attrs_define
class WorkerProfileExportOptions:
    """
    Attributes:
        region_ids (list[str] | None | Unset): Specifies a list of Azure IDs assigned to regions whose worker profiles
            will be exported.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        worker_profile_export_options = cls(
            region_ids=region_ids,
        )

        return worker_profile_export_options
