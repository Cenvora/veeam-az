...
T = TypeVar("T", bound="ArchiveRepositoryConfiguration")


@_attrs_define
class ArchiveRepositoryConfiguration:
    """Configuration of target locations where archived backups are stored.

    Attributes:
        default_repository_id (UUID | Unset): System ID assigned to the default archive repository in the Veeam Backup
            for Microsoft Azure REST API.
        default_repository_name (str | Unset): Name of the default archive repository.
        items (list[RepositoryConfigurationItem] | Unset): Region-specific archive repository settings. If not provided,
            the default archive repository will be used for all regions.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        archive_repository_configuration = cls(
            default_repository_id=default_repository_id,
            default_repository_name=default_repository_name,
            items=items,
        )

        archive_repository_configuration.additional_properties = d
        return archive_repository_configuration
