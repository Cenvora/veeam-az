...
T = TypeVar("T", bound="AsyncOperationOfNullableResourceGroupLinks")


@_attrs_define
class AsyncOperationOfNullableResourceGroupLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_nullable_resource_group_links = cls()
        ...
        async_operation_of_nullable_resource_group_links.additional_properties = additional_properties
        return async_operation_of_nullable_resource_group_links
