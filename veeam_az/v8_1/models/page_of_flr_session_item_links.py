...
T = TypeVar("T", bound="PageOfFlrSessionItemLinks")


@_attrs_define
class PageOfFlrSessionItemLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_flr_session_item_links = cls()
        ...
        page_of_flr_session_item_links.additional_properties = additional_properties
        return page_of_flr_session_item_links
