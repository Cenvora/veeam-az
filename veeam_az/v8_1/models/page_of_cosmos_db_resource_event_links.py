...
T = TypeVar("T", bound="PageOfCosmosDbResourceEventLinks")


@_attrs_define
class PageOfCosmosDbResourceEventLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_cosmos_db_resource_event_links = cls()
        ...
        page_of_cosmos_db_resource_event_links.additional_properties = additional_properties
        return page_of_cosmos_db_resource_event_links
