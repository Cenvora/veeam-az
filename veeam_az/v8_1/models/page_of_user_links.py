...
T = TypeVar("T", bound="PageOfUserLinks")


@_attrs_define
class PageOfUserLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_user_links.additional_properties = additional_properties
        return page_of_user_links
