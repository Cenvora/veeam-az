...
T = TypeVar("T", bound="UpdatedSqlPolicyFromClient")


@_attrs_define
class UpdatedSqlPolicyFromClient:
    r"""
    Attributes:
        ...
        service_account_id (None | Unset | UUID): Specifies the system ID assigned in the Veeam Backup for Microsoft
            Azure REST API to the service account whose permissions will be used to perform backups of Azure SQL databases.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        updated_sql_policy_from_client = cls(
            regions=regions,
            name=name,
        ...
        return updated_sql_policy_from_client
