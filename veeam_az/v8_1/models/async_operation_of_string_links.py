...
T = TypeVar("T", bound="AsyncOperationOfStringLinks")


@_attrs_define
class AsyncOperationOfStringLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_string_links = cls()
        ...
        async_operation_of_string_links.additional_properties = additional_properties
        return async_operation_of_string_links
