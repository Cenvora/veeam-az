...
T = TypeVar("T", bound="AsyncOperationOfArrayOfValidationMessageLinks")


@_attrs_define
class AsyncOperationOfArrayOfValidationMessageLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_array_of_validation_message_links = cls()
        ...
        async_operation_of_array_of_validation_message_links.additional_properties = additional_properties
        return async_operation_of_array_of_validation_message_links
