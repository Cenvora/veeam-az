...
T = TypeVar("T", bound="AsyncOperationOfObjectLinks")


@_attrs_define
class AsyncOperationOfObjectLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_object_links = cls()
        ...
        async_operation_of_object_links.additional_properties = additional_properties
        return async_operation_of_object_links
