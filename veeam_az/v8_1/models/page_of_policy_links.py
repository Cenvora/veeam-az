...
T = TypeVar("T", bound="PageOfPolicyLinks")


@_attrs_define
class PageOfPolicyLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_policy_links.additional_properties = additional_properties
        return page_of_policy_links
