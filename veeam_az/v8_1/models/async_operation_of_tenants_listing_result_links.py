...
T = TypeVar("T", bound="AsyncOperationOfTenantsListingResultLinks")


@_attrs_define
class AsyncOperationOfTenantsListingResultLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_tenants_listing_result_links = cls()
        ...
        async_operation_of_tenants_listing_result_links.additional_properties = additional_properties
        return async_operation_of_tenants_listing_result_links
