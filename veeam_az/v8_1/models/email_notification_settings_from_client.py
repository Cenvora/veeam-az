...
T = TypeVar("T", bound="EmailNotificationSettingsFromClient")


@_attrs_define
class EmailNotificationSettingsFromClient:
    """
    Attributes:
        smtp_settings (SmtpSettingsFromClient | Unset): Specifies the settings of the SMTP server.
        notifications_enabled (bool | None | Unset): Defines whether to enable the email notifications. The default
            value is *false*.
        from_ (None | str | Unset): Specifies the email address from which the email notifications will be sent.
        to (None | str | Unset): Specifies the email addresses of the notification recipients.
        subject (None | str | Unset): Specifies the subject of the notification message. The default value is
            *[%JobResult%] %JobName% (%ObjectCount% instances) %Issues%*.
    ...
    smtp_settings: SmtpSettingsFromClient | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        smtp_settings: SmtpSettingsFromClient | Unset
        if isinstance(_smtp_settings, Unset):
            smtp_settings = UNSET
        else:
            smtp_settings = SmtpSettingsFromClient.from_dict(_smtp_settings)
        ...
        email_notification_settings_from_client = cls(
        ...
        return email_notification_settings_from_client
