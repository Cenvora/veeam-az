...
T = TypeVar("T", bound="PageOfWorkerProfileLinks")


@_attrs_define
class PageOfWorkerProfileLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_worker_profile_links = cls()
        ...
        page_of_worker_profile_links.additional_properties = additional_properties
        return page_of_worker_profile_links
