...
T = TypeVar("T", bound="UpdatedStandardAccountFromClient")


@_attrs_define
class UpdatedStandardAccountFromClient:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        updated_standard_account_from_client = cls(
            name=name,
            kind=kind,
        ...
        return updated_standard_account_from_client
