...
from ..models.cosmos_db_policy_backup_item_type import CosmosDbPolicyBackupItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="CosmosDbPolicyItemDeletedFromAzure")


@_attrs_define
class CosmosDbPolicyItemDeletedFromAzure:
    """Specifies information on a resource deleted from the Microsoft Azure infrastructure.

    Attributes:
        type_ (CosmosDbPolicyBackupItemType | Unset): Type of the protected resource.
        name (None | str | Unset): Name of the deleted resource.
        id (None | str | Unset): Internal ID assigned to the deleted resource in the Veeam Backup for Microsoft Azure
            REST API.
    ...
    type_: CosmosDbPolicyBackupItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: CosmosDbPolicyBackupItemType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = CosmosDbPolicyBackupItemType(_type_)
        ...
        cosmos_db_policy_item_deleted_from_azure = cls(
            type_=type_,
            name=name,
            id=id,
            tag_value=tag_value,
        ...
        return cosmos_db_policy_item_deleted_from_azure
