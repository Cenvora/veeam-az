...
T = TypeVar("T", bound="NewCosmosDbPolicyFromClient")


@_attrs_define
class NewCosmosDbPolicyFromClient:
    r"""
    Attributes:
        ...
        service_account_id (UUID): Specifies the system ID assigned in the Veeam Backup for Microsoft Azure REST API to
            a service account whose permissions will be used to perform Cosmos DB backup.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_cosmos_db_policy_from_client = cls(
            tenant_id=tenant_id,
        ...
        return new_cosmos_db_policy_from_client
