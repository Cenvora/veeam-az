...
T = TypeVar("T", bound="PageOfRepositoryValidateDeleteLinks")


@_attrs_define
class PageOfRepositoryValidateDeleteLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_repository_validate_delete_links = cls()
        ...
        page_of_repository_validate_delete_links.additional_properties = additional_properties
        return page_of_repository_validate_delete_links
