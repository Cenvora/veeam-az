...
T = TypeVar("T", bound="PageOfFileSharePolicyLinks")


@_attrs_define
class PageOfFileSharePolicyLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_file_share_policy_links = cls()
        ...
        page_of_file_share_policy_links.additional_properties = additional_properties
        return page_of_file_share_policy_links
