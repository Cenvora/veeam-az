...
T = TypeVar("T", bound="LinksDictionaryType0")


@_attrs_define
class LinksDictionaryType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        links_dictionary_type_0.additional_properties = additional_properties
        return links_dictionary_type_0
