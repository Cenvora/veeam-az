...
T = TypeVar("T", bound="PageOfSqlServerLinks")


@_attrs_define
class PageOfSqlServerLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_sql_server_links.additional_properties = additional_properties
        return page_of_sql_server_links
