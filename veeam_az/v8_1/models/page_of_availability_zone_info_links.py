...
T = TypeVar("T", bound="PageOfAvailabilityZoneInfoLinks")


@_attrs_define
class PageOfAvailabilityZoneInfoLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_availability_zone_info_links = cls()
        ...
        page_of_availability_zone_info_links.additional_properties = additional_properties
        return page_of_availability_zone_info_links
