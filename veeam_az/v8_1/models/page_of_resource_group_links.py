...
T = TypeVar("T", bound="PageOfResourceGroupLinks")


@_attrs_define
class PageOfResourceGroupLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_resource_group_links = cls()
        ...
        page_of_resource_group_links.additional_properties = additional_properties
        return page_of_resource_group_links
