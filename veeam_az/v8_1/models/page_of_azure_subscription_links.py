...
T = TypeVar("T", bound="PageOfAzureSubscriptionLinks")


@_attrs_define
class PageOfAzureSubscriptionLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_azure_subscription_links = cls()
        ...
        page_of_azure_subscription_links.additional_properties = additional_properties
        return page_of_azure_subscription_links
