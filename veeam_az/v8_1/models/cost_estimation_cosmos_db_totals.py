...
T = TypeVar("T", bound="CostEstimationCosmosDbTotals")


@_attrs_define
class CostEstimationCosmosDbTotals:
    ...
    Attributes:
        ...
        total_continuous_backup_costs (CostEstimationTotalValue | Unset): Information on the estimated total cost value.
    ...
    total_continuous_backup_costs: CostEstimationTotalValue | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        total_continuous_backup_costs: dict[str, Any] | Unset = UNSET
        if not isinstance(self.total_continuous_backup_costs, Unset):
            total_continuous_backup_costs = self.total_continuous_backup_costs.to_dict()
        ...
        if total_continuous_backup_costs is not UNSET:
            field_dict["totalContinuousBackupCosts"] = total_continuous_backup_costs
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _total_continuous_backup_costs = d.pop("totalContinuousBackupCosts", UNSET)
        total_continuous_backup_costs: CostEstimationTotalValue | Unset
        if isinstance(_total_continuous_backup_costs, Unset):
            total_continuous_backup_costs = UNSET
        else:
            total_continuous_backup_costs = CostEstimationTotalValue.from_dict(_total_continuous_backup_costs)
        ...
        cost_estimation_cosmos_db_totals = cls(
            total_costs=total_costs,
            total_continuous_backup_costs=total_continuous_backup_costs,
            total_backup_costs=total_backup_costs,
            total_traffic_costs=total_traffic_costs,
            total_transaction_costs=total_transaction_costs,
        )

        return cost_estimation_cosmos_db_totals
