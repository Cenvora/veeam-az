...
T = TypeVar("T", bound="CostEstimationFileSharePolicyFromClient")


@_attrs_define
class CostEstimationFileSharePolicyFromClient:
    r"""
    Attributes:
        tenant_id (str): Specifies the Microsoft Azure ID assigned to a tenant for which the backup policy is created.
        service_account_id (UUID): Specifies the system ID assigned in the Veeam Backup for Microsoft Azure REST API to
            a service account whose permissions are used to perform backup of Azure file shares.
        regions (list[PolicyRegionFromClient]): Specifies Azure regions where the protected resources reside.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cost_estimation_file_share_policy_from_client = cls(
            tenant_id=tenant_id,
        ...
        return cost_estimation_file_share_policy_from_client
