...
T = TypeVar("T", bound="AsyncOperationOfGrantPermissionsResultLinks")


@_attrs_define
class AsyncOperationOfGrantPermissionsResultLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_grant_permissions_result_links = cls()
        ...
        async_operation_of_grant_permissions_result_links.additional_properties = additional_properties
        return async_operation_of_grant_permissions_result_links
