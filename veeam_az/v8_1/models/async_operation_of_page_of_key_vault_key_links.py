...
T = TypeVar("T", bound="AsyncOperationOfPageOfKeyVaultKeyLinks")


@_attrs_define
class AsyncOperationOfPageOfKeyVaultKeyLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_page_of_key_vault_key_links = cls()
        ...
        async_operation_of_page_of_key_vault_key_links.additional_properties = additional_properties
        return async_operation_of_page_of_key_vault_key_links
