...
T = TypeVar("T", bound="CostEstimationSqlAssumptions")


@_attrs_define
class CostEstimationSqlAssumptions:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cost_estimation_sql_assumptions = cls(
            data_compression_ratio=data_compression_ratio,
        )

        return cost_estimation_sql_assumptions
