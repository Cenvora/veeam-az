...
T = TypeVar("T", bound="PageOfLicensedResourceLinks")


@_attrs_define
class PageOfLicensedResourceLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_licensed_resource_links = cls()
        ...
        page_of_licensed_resource_links.additional_properties = additional_properties
        return page_of_licensed_resource_links
