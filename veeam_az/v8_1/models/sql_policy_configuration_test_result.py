...
T = TypeVar("T", bound="SqlPolicyConfigurationTestResult")


@_attrs_define
class SqlPolicyConfigurationTestResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sql_policy_configuration_test_result = cls(
            severity=severity,
            type_=type_,
            message=message,
        )

        return sql_policy_configuration_test_result
