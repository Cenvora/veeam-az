...
if TYPE_CHECKING:
    from ..models.cost_estimation_sql_assumptions import CostEstimationSqlAssumptions
    from ..models.cost_estimation_sql_totals import CostEstimationSqlTotals
    from ..models.cost_estimation_warning_group import CostEstimationWarningGroup


T = TypeVar("T", bound="CostEstimationSqlData")


@_attrs_define
class CostEstimationSqlData:
    """Information on total estimated costs per month, assumptions and warnings.

    Attributes:
        totals (CostEstimationSqlTotals | Unset): Information on the cost estimation totals.
        assumptions (CostEstimationSqlAssumptions | Unset): Assumptions used to calculate the cost.
    ...
    totals: CostEstimationSqlTotals | Unset = UNSET
    assumptions: CostEstimationSqlAssumptions | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        totals: CostEstimationSqlTotals | Unset
        if isinstance(_totals, Unset):
            totals = UNSET
        else:
            totals = CostEstimationSqlTotals.from_dict(_totals)

        _assumptions = d.pop("assumptions", UNSET)
        assumptions: CostEstimationSqlAssumptions | Unset
        if isinstance(_assumptions, Unset):
            assumptions = UNSET
        else:
            assumptions = CostEstimationSqlAssumptions.from_dict(_assumptions)
        ...
        return cost_estimation_sql_data
