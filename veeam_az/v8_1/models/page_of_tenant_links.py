...
T = TypeVar("T", bound="PageOfTenantLinks")


@_attrs_define
class PageOfTenantLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_tenant_links.additional_properties = additional_properties
        return page_of_tenant_links
