...
T = TypeVar("T", bound="CosmosDbPoliciesExportOptions")


@_attrs_define
class CosmosDbPoliciesExportOptions:
    """
    Attributes:
        policy_ids (list[UUID] | None | Unset): Returns only information on the policies with the specified IDs.
        policy_name (None | str | Unset): Returns a backup policy with the specified name.
        last_job_status (list[JobStatus] | None | Unset): Returns only backup policies with the specified status of the
            latest session.
        policy_status (list[PolicyStatus] | None | Unset): Returns only backup policies with the specified status.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cosmos_db_policies_export_options = cls(
        ...
        cosmos_db_policies_export_options.additional_properties = d
        return cosmos_db_policies_export_options
