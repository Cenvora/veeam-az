...
T = TypeVar("T", bound="PageOfProtectedVirtualMachineExtendedLinks")


@_attrs_define
class PageOfProtectedVirtualMachineExtendedLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_protected_virtual_machine_extended_links = cls()
        ...
        page_of_protected_virtual_machine_extended_links.additional_properties = additional_properties
        return page_of_protected_virtual_machine_extended_links
