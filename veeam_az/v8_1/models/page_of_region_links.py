...
T = TypeVar("T", bound="PageOfRegionLinks")


@_attrs_define
class PageOfRegionLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_region_links.additional_properties = additional_properties
        return page_of_region_links
