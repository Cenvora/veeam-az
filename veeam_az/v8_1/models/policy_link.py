...
class PolicyLink:
    ...
    Attributes:
        id (UUID | Unset):
        is_protection_policy (bool | None | Unset):
    ...
    id: UUID | Unset = UNSET
    is_protection_policy: bool | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        is_protection_policy: bool | None | Unset
        if isinstance(self.is_protection_policy, Unset):
            is_protection_policy = UNSET
        else:
            is_protection_policy = self.is_protection_policy
        ...
        if id is not UNSET:
            field_dict["id"] = id
        if is_protection_policy is not UNSET:
            field_dict["isProtectionPolicy"] = is_protection_policy
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_is_protection_policy(data: object) -> bool | None | Unset:
            if data is None:
                return data
        ...
        is_protection_policy = _parse_is_protection_policy(d.pop("isProtectionPolicy", UNSET))
        ...
        policy_link = cls(
            id=id,
            is_protection_policy=is_protection_policy,
