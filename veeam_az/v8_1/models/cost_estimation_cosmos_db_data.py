...
if TYPE_CHECKING:
    from ..models.cost_estimation_cosmos_db_assumptions import CostEstimationCosmosDbAssumptions
    from ..models.cost_estimation_cosmos_db_totals import CostEstimationCosmosDbTotals
    from ..models.cost_estimation_warning_group import CostEstimationWarningGroup


T = TypeVar("T", bound="CostEstimationCosmosDbData")


@_attrs_define
class CostEstimationCosmosDbData:
    """Information on the warning groups of the backup policy estimated cost.

    Attributes:
        totals (CostEstimationCosmosDbTotals | Unset): Information on the cost estimation totals.
        assumptions (CostEstimationCosmosDbAssumptions | Unset): Assumptions used to calculate the cost.
    ...
    totals: CostEstimationCosmosDbTotals | Unset = UNSET
    assumptions: CostEstimationCosmosDbAssumptions | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        totals: CostEstimationCosmosDbTotals | Unset
        if isinstance(_totals, Unset):
            totals = UNSET
        else:
            totals = CostEstimationCosmosDbTotals.from_dict(_totals)

        _assumptions = d.pop("assumptions", UNSET)
        assumptions: CostEstimationCosmosDbAssumptions | Unset
        if isinstance(_assumptions, Unset):
            assumptions = UNSET
        else:
            assumptions = CostEstimationCosmosDbAssumptions.from_dict(_assumptions)
        ...
        cost_estimation_cosmos_db_data = cls(
            totals=totals,
        ...
        return cost_estimation_cosmos_db_data
