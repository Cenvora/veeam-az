...
T = TypeVar("T", bound="PageOfProtectedVnetExtendedLinks")


@_attrs_define
class PageOfProtectedVnetExtendedLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_protected_vnet_extended_links = cls()
        ...
        page_of_protected_vnet_extended_links.additional_properties = additional_properties
        return page_of_protected_vnet_extended_links
