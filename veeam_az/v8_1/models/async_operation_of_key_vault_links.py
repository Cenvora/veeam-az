...
T = TypeVar("T", bound="AsyncOperationOfKeyVaultLinks")


@_attrs_define
class AsyncOperationOfKeyVaultLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_key_vault_links = cls()
        ...
        async_operation_of_key_vault_links.additional_properties = additional_properties
        return async_operation_of_key_vault_links
