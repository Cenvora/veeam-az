...
T = TypeVar("T", bound="ProtectedFileShare")


@_attrs_define
class ProtectedFileShare:
    """Information on each protected file share.
    ...
    Attributes:
        ...
        size_in_mb (int | Unset): Size of the file share (in MB).
        subscription_id (UUID | Unset): Microsoft Azure ID assigned to a subscription where the file share belongs.
        last_backup (datetime.datetime | Unset): Date and time of the most recent backup of the protected file share.
