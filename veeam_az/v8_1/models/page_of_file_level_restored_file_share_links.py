...
T = TypeVar("T", bound="PageOfFileLevelRestoredFileShareLinks")


@_attrs_define
class PageOfFileLevelRestoredFileShareLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_file_level_restored_file_share_links = cls()
        ...
        page_of_file_level_restored_file_share_links.additional_properties = additional_properties
        return page_of_file_level_restored_file_share_links
