...
T = TypeVar("T", bound="PageOfDiskSnapshotLinks")


@_attrs_define
class PageOfDiskSnapshotLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_disk_snapshot_links = cls()
        ...
        page_of_disk_snapshot_links.additional_properties = additional_properties
        return page_of_disk_snapshot_links
