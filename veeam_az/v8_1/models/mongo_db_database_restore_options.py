...
if TYPE_CHECKING:
    from ..models.mongo_db_collection_restore_options import MongoDbCollectionRestoreOptions
    from ..models.mongo_db_throughput_settings import MongoDbThroughputSettings


T = TypeVar("T", bound="MongoDbDatabaseRestoreOptions")


@_attrs_define
class MongoDbDatabaseRestoreOptions:
    """
    Attributes:
        name (str | Unset):
        new_name (None | str | Unset):
        collections (list[MongoDbCollectionRestoreOptions] | None | Unset):
        throughput_settings (MongoDbThroughputSettings | Unset):
    """

    name: str | Unset = UNSET
    new_name: None | str | Unset = UNSET
    collections: list[MongoDbCollectionRestoreOptions] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_collections(data: object) -> list[MongoDbCollectionRestoreOptions] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for collections_type_0_item_data in _collections_type_0:
                    collections_type_0_item = MongoDbCollectionRestoreOptions.from_dict(collections_type_0_item_data)
                ...
                pass
            return cast(list[MongoDbCollectionRestoreOptions] | None | Unset, data)
        ...
        mongo_db_database_restore_options = cls(
            name=name,
            new_name=new_name,
        ...
        mongo_db_database_restore_options.additional_properties = d
        return mongo_db_database_restore_options
