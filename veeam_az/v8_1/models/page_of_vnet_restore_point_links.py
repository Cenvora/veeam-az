...
T = TypeVar("T", bound="PageOfVnetRestorePointLinks")


@_attrs_define
class PageOfVnetRestorePointLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_vnet_restore_point_links = cls()
        ...
        page_of_vnet_restore_point_links.additional_properties = additional_properties
        return page_of_vnet_restore_point_links
