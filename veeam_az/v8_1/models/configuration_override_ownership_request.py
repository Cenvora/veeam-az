...
T = TypeVar("T", bound="ConfigurationOverrideOwnershipRequest")


@_attrs_define
class ConfigurationOverrideOwnershipRequest:
    """
    Attributes:
        repository_ids (list[UUID] | Unset): Specifies repositories for which you want to override the owner.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        configuration_override_ownership_request = cls(
            repository_ids=repository_ids,
        )

        configuration_override_ownership_request.additional_properties = d
        return configuration_override_ownership_request
