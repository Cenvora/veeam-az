...
T = TypeVar("T", bound="CostEstimationCosmosDbPolicyFromClient")


@_attrs_define
class CostEstimationCosmosDbPolicyFromClient:
    r"""
    Attributes:
        tenant_id (str): Specifies a Microsoft Azure ID assigned to a tenant to which the protected Azure resources
            belong.
        service_account_id (UUID): Specifies the system ID assigned in the Veeam Backup for Microsoft Azure REST API to
            a service account whose permissions are used to perform Cosmos DB backup.
        regions (list[PolicyRegionFromClient]): Azure regions where the backed-up resources reside.
        name (str): Specifies a name of the backup policy.
        ...
        default_backup_account_id (None | str | Unset): /[Applies only to backup policies that have the *Backup to
            ...
            a default database account that is used to access all protected databases.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cost_estimation_cosmos_db_policy_from_client = cls(
            tenant_id=tenant_id,
        ...
        return cost_estimation_cosmos_db_policy_from_client
