...
T = TypeVar("T", bound="AsyncOperationOfPageOfSqlServerLinks")


@_attrs_define
class AsyncOperationOfPageOfSqlServerLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        async_operation_of_page_of_sql_server_links = cls()
        ...
        async_operation_of_page_of_sql_server_links.additional_properties = additional_properties
        return async_operation_of_page_of_sql_server_links
