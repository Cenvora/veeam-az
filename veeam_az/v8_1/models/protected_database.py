...
T = TypeVar("T", bound="ProtectedDatabase")
...
class ProtectedDatabase:
    """
    Attributes:
        id (None | str | Unset): System ID assigned to the protected SQL database in the Veeam Backup for Microsoft
            Azure REST API.
        azure_id (None | str | Unset): Resource ID of the protected SQL database.
        ...
        sql_elastic_pool (None | str | Unset): System ID assigned in the Veeam Backup for Microsoft Azure REST API to
            the SQL elastic pool to which the database belongs.
        last_backup (datetime.datetime | Unset): Date and time of the most recent backup of the protected database.
