...
T = TypeVar("T", bound="AvailabilityZoneInfo")


@_attrs_define
class AvailabilityZoneInfo:
    """Specifies information on an availability zone.

    Attributes:
        subscription_id (None | str | Unset): Microsoft Azure ID assigned to a subscription where an availability zone
            belongs.
        region_id (None | str | Unset): Microsoft Azure ID assigned to a region in which the availability zone is
            located.
        name (None | str | Unset): Name of the availability zone.
