...
T = TypeVar("T", bound="PageOfCostEstimationSqlItemLinks")


@_attrs_define
class PageOfCostEstimationSqlItemLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_cost_estimation_sql_item_links = cls()
        ...
        page_of_cost_estimation_sql_item_links.additional_properties = additional_properties
        return page_of_cost_estimation_sql_item_links
