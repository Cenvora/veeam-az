...
T = TypeVar("T", bound="PageOfConfigurationRestorePointLinks")


@_attrs_define
class PageOfConfigurationRestorePointLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_configuration_restore_point_links = cls()
        ...
        page_of_configuration_restore_point_links.additional_properties = additional_properties
        return page_of_configuration_restore_point_links
