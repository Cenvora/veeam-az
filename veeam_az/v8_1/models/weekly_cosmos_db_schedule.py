...
T = TypeVar("T", bound="WeeklyCosmosDbSchedule")


@_attrs_define
class WeeklyCosmosDbSchedule:
    """/[Applies only to backup policies that have the *Backup to repository* option enabled] Specifies weekly schedule
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        weekly_cosmos_db_schedule = cls(
            start_time=start_time,
            backup_schedule=backup_schedule,
        )

        return weekly_cosmos_db_schedule
