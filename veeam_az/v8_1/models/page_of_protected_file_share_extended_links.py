...
T = TypeVar("T", bound="PageOfProtectedFileShareExtendedLinks")


@_attrs_define
class PageOfProtectedFileShareExtendedLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_protected_file_share_extended_links = cls()
        ...
        page_of_protected_file_share_extended_links.additional_properties = additional_properties
        return page_of_protected_file_share_extended_links
