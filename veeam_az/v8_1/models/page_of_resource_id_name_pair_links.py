...
T = TypeVar("T", bound="PageOfResourceIdNamePairLinks")


@_attrs_define
class PageOfResourceIdNamePairLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_resource_id_name_pair_links = cls()
        ...
        page_of_resource_id_name_pair_links.additional_properties = additional_properties
        return page_of_resource_id_name_pair_links
