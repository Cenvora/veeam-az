...
T = TypeVar("T", bound="PageOfStandardAccountNameLinks")


@_attrs_define
class PageOfStandardAccountNameLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_standard_account_name_links = cls()
        ...
        page_of_standard_account_name_links.additional_properties = additional_properties
        return page_of_standard_account_name_links
