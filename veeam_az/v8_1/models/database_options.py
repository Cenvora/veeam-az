...
T = TypeVar("T", bound="DatabaseOptions")
...
class DatabaseOptions:
    ...
    Attributes:
        ...
        service_account_id (str | Unset): Returns only SQL databases to which a service account with the specified ID
            has access.
