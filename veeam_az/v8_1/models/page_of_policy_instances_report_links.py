...
T = TypeVar("T", bound="PageOfPolicyInstancesReportLinks")


@_attrs_define
class PageOfPolicyInstancesReportLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_policy_instances_report_links = cls()
        ...
        page_of_policy_instances_report_links.additional_properties = additional_properties
        return page_of_policy_instances_report_links
