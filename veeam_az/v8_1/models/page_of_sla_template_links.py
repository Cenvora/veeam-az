...
T = TypeVar("T", bound="PageOfSlaTemplateLinks")


@_attrs_define
class PageOfSlaTemplateLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_sla_template_links = cls()
        ...
        page_of_sla_template_links.additional_properties = additional_properties
        return page_of_sla_template_links
