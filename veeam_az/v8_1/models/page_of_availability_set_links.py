...
T = TypeVar("T", bound="PageOfAvailabilitySetLinks")


@_attrs_define
class PageOfAvailabilitySetLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_availability_set_links = cls()
        ...
        page_of_availability_set_links.additional_properties = additional_properties
        return page_of_availability_set_links
