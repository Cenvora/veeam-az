...
T = TypeVar("T", bound="PageOfVnetRestorePointResourceLinks")


@_attrs_define
class PageOfVnetRestorePointResourceLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        page_of_vnet_restore_point_resource_links = cls()
        ...
        page_of_vnet_restore_point_resource_links.additional_properties = additional_properties
        return page_of_vnet_restore_point_resource_links
