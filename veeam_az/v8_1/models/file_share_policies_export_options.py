...
T = TypeVar("T", bound="FileSharePoliciesExportOptions")


@_attrs_define
class FileSharePoliciesExportOptions:
    """
    Attributes:
        policy_ids (list[UUID] | None | Unset): Specifies the system IDs assigned in the Veeam Backup for Microsoft
            Azure REST API to the file share backup policies whose data will be exported.
        policy_name (None | str | Unset): Exports only data on the backup policy with the specified name.
        last_job_status (list[JobStatus] | None | Unset): Exports only data on backup policies with the specified status
            of the latest session.
        policy_status (list[PolicyStatus] | None | Unset): Exports only data on the backup policies with the specified
            statuses.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        file_share_policies_export_options = cls(
        ...
        return file_share_policies_export_options
