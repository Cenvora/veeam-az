...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/policies/sql/{policy_id}/regions".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Azure Regions Specified in Policy Settings
     ...
     The HTTP GET request to the `/policies/sql/{policyId}/regions` retrieves a list of Azure regions
    added to a SQL backup policy with the specified ID.
