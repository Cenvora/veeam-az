...
def sync_detailed(
    ...
    *,
    ...
    """Remove Backup Policy
     ...
     The HTTP DELETE request to the `/policies/sql/{policyId}` endpoint deletes a specific SQL backup
    policy from the Veeam Backup for Microsoft Azure configuration database.
