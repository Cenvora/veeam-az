...
from ...models.page_of_sql_policy import PageOfSqlPolicy
...
) -> PageOfSqlPolicy | ProblemDetails400 | ProblemDetails401 | ProblemDetails403 | None:
    if response.status_code == 200:
        response_200 = PageOfSqlPolicy.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PageOfSqlPolicy | ProblemDetails400 | ProblemDetails401 | ProblemDetails403]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Collection of SQL Backup Policies
     ...
     The HTTP GET request to the `/policies/sql` endpoint retrieves a list of SQL backup policies
...
def sync(
    *,
    ...
    Returns:
        PageOfSqlPolicy | ProblemDetails400 | ProblemDetails401 | ProblemDetails403
    """
