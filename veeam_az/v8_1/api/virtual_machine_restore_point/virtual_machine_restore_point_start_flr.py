...
from ...models.flr_options import FlrOptions
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/restorePoints/virtualMachines/{restore_point_id}/restoreFile".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Perform Azure VM File-Level Restore
     ...
     The HTTP POST request to the `/restorePoints/virtualMachines/{restorePointId}/restoreFile` endpoint
    launches a file-level restore operation using a specific restore point of an Azure VM.
