...
from ...models.page_of_vm_snapshot import PageOfVmSnapshot
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/restorePoints/virtualMachines/snapshots",
        "params": params,
    }
...
) -> PageOfVmSnapshot | ProblemDetails400 | ProblemDetails401 | ProblemDetails403 | None:
    if response.status_code == 200:
        response_200 = PageOfVmSnapshot.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PageOfVmSnapshot | ProblemDetails400 | ProblemDetails401 | ProblemDetails403]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Collection of Azure VM Snapshots
     ...
     The HTTP GET request to the `/restorePoints/virtualMachines/snapshots` endpoint retrieves a list of
...
def sync(
    *,
    ...
    Returns:
        PageOfVmSnapshot | ProblemDetails400 | ProblemDetails401 | ProblemDetails403
    """
