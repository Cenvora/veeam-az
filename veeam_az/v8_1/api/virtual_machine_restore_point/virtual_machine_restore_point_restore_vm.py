...
def _get_kwargs(
    ...
    *,
    body: VirtualMachineRestoreOptions,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/restorePoints/virtualMachines/{restore_point_id}/restoreVirtualMachine".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        restore_point_id (UUID):
        body (VirtualMachineRestoreOptions): Specifies Azure VM restore options.
