...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/restorePoints/virtualMachines/{restore_point_id}/extendRetrievedDataAvailability".format(
...
def sync_detailed(
    ...
    *,
    ...
    `/restorePoints/virtualMachines/{restorePointId}/extendRetrievedDataAvailability` endpoint extends
    the data availability period of a retrieved restore point with the specified ID.
