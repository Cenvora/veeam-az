...
from ...models.page_of_virtual_machine_restore_point import PageOfVirtualMachineRestorePoint
...
def _get_kwargs(
    *,
    ...
    json_disk_id: None | str | Unset
    if isinstance(disk_id, Unset):
        json_disk_id = UNSET
    else:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/restorePoints/virtualMachines",
        "params": params,
    }
...
) -> PageOfVirtualMachineRestorePoint | ProblemDetails400 | ProblemDetails401 | ProblemDetails403 | None:
    if response.status_code == 200:
        response_200 = PageOfVirtualMachineRestorePoint.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PageOfVirtualMachineRestorePoint | ProblemDetails400 | ProblemDetails401 | ProblemDetails403]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Azure VM Restore Points
     ...
     The HTTP GET request to the `/restorePoints/virtualMachines` endpoint retrieves a list of restore
    points created for Azure VMs by Veeam Backup for Microsoft Azure.
...
def sync(
    *,
    ...
    Returns:
        PageOfVirtualMachineRestorePoint | ProblemDetails400 | ProblemDetails401 | ProblemDetails403
    """
