...
from ...models.file_share_flr_options import FileShareFlrOptions
...
def _get_kwargs(
    ...
    *,
    body: FileShareFlrOptions,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/restorePoints/fileShares/{restore_point_id}/restoreFile".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Perform File Share File-Level Restore
     ...
     The HTTP POST request to the `/restorePoints/fileShares/{restorePointId}/restoreFile` endpoint
    launches a file-level restore operation using a specific restore point of an Azure file share.
