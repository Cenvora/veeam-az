...
def sync_detailed(
    ...
    *,
    ...
    """Remove File Share Restore Point
     ...
     The HTTP DELETE request to the `/restorePoints/fileShares/{restorePointId}` endpoint removes a
    specific restore point of an Azure file share from the Veeam Backup for Microsoft Azure
