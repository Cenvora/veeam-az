...
from ...models.page_of_sql_restore_point import PageOfSqlRestorePoint
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/restorePoints/sql",
        "params": params,
    }
...
) -> PageOfSqlRestorePoint | ProblemDetails400 | ProblemDetails401 | ProblemDetails403 | None:
    if response.status_code == 200:
        response_200 = PageOfSqlRestorePoint.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PageOfSqlRestorePoint | ProblemDetails400 | ProblemDetails401 | ProblemDetails403]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get SQL Database Restore Points
     ...
     The HTTP GET request to the `/restorePoints/sql` endpoint retrieves a list of restore points created
    for SQL databases by Veeam Backup for Microsoft Azure.
...
def sync(
    *,
    ...
    Returns:
        PageOfSqlRestorePoint | ProblemDetails400 | ProblemDetails401 | ProblemDetails403
    """
