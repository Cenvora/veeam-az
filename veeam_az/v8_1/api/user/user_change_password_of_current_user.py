...
from ...models.change_password_of_current_user_data import ChangePasswordOfCurrentUserData
...
def _get_kwargs(
    *,
    body: ChangePasswordOfCurrentUserData,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/users/changePassword",
    }
...
def sync_detailed(
    *,
    ...
    """Change Password of Current User
     ...
     The HTTP POST request to the `/users/changePassword` endpoint changes the password of a user that is
    currently authorized in the Veeam Backup for Microsoft Azure REST API.
