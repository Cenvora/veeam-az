...
from ...models.change_users_password_data import ChangeUsersPasswordData
...
def _get_kwargs(
    user_id: str,
    *,
    body: ChangeUsersPasswordData,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/users/{user_id}/changePassword".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Change User Password
     ...
     The HTTP POST request to the `/users/{userId}/changePassword` endpoint changes password of a user
