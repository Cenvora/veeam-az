...
from ...models.updated_vnet_policy_from_client import UpdatedVnetPolicyFromClient
from ...types import Response


def _get_kwargs(
    *,
    body: UpdatedVnetPolicyFromClient,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Modify Virtual Network Configuration Backup Policy
     ...
     The HTTP PUT request to the `/policy/vnet` endpoint updates settings of the virtual network
