...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/cloudInfrastructure/cosmosDb/{cosmos_db_account_id}/availableRestoreRegions".format(
...
def sync_detailed(
    ...
    *,
    ...
    `/cloudInfrastructure/cosmosDb/{cosmosDbAccountId}/availableRestoreRegions` endpoint retrieves list
    of regions to which a Cosmos DB account with the specified ID can be restored.
