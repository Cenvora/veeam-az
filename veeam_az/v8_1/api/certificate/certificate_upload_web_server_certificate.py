...
from ...models.uploaded_web_server_certificate import UploadedWebServerCertificate
from ...types import Response


def _get_kwargs(
    *,
    body: UploadedWebServerCertificate,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v8.1/settings/certificates/webServer",
    }
