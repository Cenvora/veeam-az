...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/flr/{flr_session_id}/restore/{restore_task_id}/stop".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Stop Restore Task
     ...
     The HTTP POST request to the `/api/v8.1/flr/{flrSessionId}/restore/{restoreTaskId}/stop` endpoint
    allows you to stop a restore task with the specified ID.
