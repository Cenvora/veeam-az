...
def sync_detailed(
    ...
    *,
    ...
    """Remove SLA Template
     ...
     The HTTP DELETE request to the `/policyTemplates/slaTemplate/{templateId}` endpoint deletes a
    specific SLA template from the Veeam Backup for Microsoft Azure configuration database.
