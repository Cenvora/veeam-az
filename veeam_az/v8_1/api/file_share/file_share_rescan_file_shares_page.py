...
from ...models.async_operation_of_page_of_file_share import AsyncOperationOfPageOfFileShare
from ...models.file_share_backup_destination_filter_options import FileShareBackupDestinationFilterOptions
...
def _get_kwargs(
    *,
    ...
    backup_destination: list[FileShareBackupDestinationFilterOptions] | None | Unset = UNSET,
) -> dict[str, Any]:
    ...
    params["FileShareFromProtectedRegions"] = file_share_from_protected_regions
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/fileShares/rescan",
        "params": params,
    }
...
) -> AsyncOperationOfPageOfFileShare | ProblemDetails400 | ProblemDetails401 | ProblemDetails403 | None:
    if response.status_code == 202:
        response_202 = AsyncOperationOfPageOfFileShare.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AsyncOperationOfPageOfFileShare | ProblemDetails400 | ProblemDetails401 | ProblemDetails403]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Azure Files Rescan
     ...
     The HTTP POST request to the `/fileShares/rescan` endpoint launches a rescan operation for Azure
    file shares in the Microsoft Azure environment.
    ...
    Args:
        ...
        file_share_from_protected_regions (bool | Unset):
        protection_status (list[ProtectionStatus] | None | Unset):
        backup_destination (list[FileShareBackupDestinationFilterOptions] | None | Unset):
...
def sync(
    *,
    ...
    Returns:
        AsyncOperationOfPageOfFileShare | ProblemDetails400 | ProblemDetails401 | ProblemDetails403
    """
