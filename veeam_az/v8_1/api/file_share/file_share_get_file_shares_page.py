...
from ...models.page_of_file_share import PageOfFileShare
...
) -> PageOfFileShare | ProblemDetails400 | ProblemDetails401 | ProblemDetails403 | None:
    if response.status_code == 200:
        response_200 = PageOfFileShare.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PageOfFileShare | ProblemDetails400 | ProblemDetails401 | ProblemDetails403]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Collection of File Shares
     ...
     The HTTP GET request to the `/fileShares` collection retrieves a list of Azure file shares created
    in Microsoft Azure environment and available for Veeam Backup for Microsoft Azure.
...
def sync(
    *,
    ...
    Returns:
        PageOfFileShare | ProblemDetails400 | ProblemDetails401 | ProblemDetails403
    """
