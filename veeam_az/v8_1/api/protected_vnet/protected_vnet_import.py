...
def _get_kwargs() -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/protectedItem/vnet/import",
    }
...
def sync_detailed(
    *,
    ...
    """Import Virtual Network Configuration Backup Copies
     ...
     The HTTP POST request to the `/protectedItem/vnet/import` endpoint imports all virtual network
    configuration backup copies stored in backup repositories to the Veeam Backup for Microsoft Azure
