...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/policies/fileShares/orderPriorities",
    }
...
def sync_detailed(
    *,
    ...
    """Set Backup Policy Priority
     ...
     The HTTP POST request to the `/policies/fileShares/orderPriorities` endpoint sets the priority order
    for file share backup policies.
