...
def sync_detailed(
    ...
    *,
    ...
    """Remove Backup Policy
     ...
     The HTTP DELETE request to the `/policies/fileShares/{policyId}` endpoint deletes a specific file
    share backup policy from the Veeam Backup for Microsoft Azure configuration database.
