...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/policies/fileShares/{policy_id}/disable".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Disable Backup Policy
     ...
     The HTTP POST request to the `/policies/fileShares/{policyId}/disable` endpoint disables an enabled
