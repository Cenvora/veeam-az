...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/protectedItem/virtualMachines/deleteSnapshots",
    }
...
def sync_detailed(
    *,
    ...
    """Remove Snapshots of Protected Azure VMs
     ...
     The HTTP POST request to the `/protectedItem/virtualMachines/deleteSnapshots` endpoint removes
    snapshots created for Azure VMs with the specified IDs.
