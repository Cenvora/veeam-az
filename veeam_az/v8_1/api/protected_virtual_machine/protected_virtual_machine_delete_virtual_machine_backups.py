...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/protectedItem/virtualMachines/{id}/deleteBackups".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Remove Backups of Protected Azure VM
     ...
     The HTTP POST request to the `/protectedItem/virtualMachines/{id}/deleteBackups` endpoint deletes
    backups created for an Azure VM with the specified ID.
