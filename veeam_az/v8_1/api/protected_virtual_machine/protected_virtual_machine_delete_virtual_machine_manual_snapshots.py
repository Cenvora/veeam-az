...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/protectedItem/virtualMachines/{id}/deleteManualSnapshots".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Remove Manual Snapshots of Protected Azure VM
     ...
     The HTTP POST request to the `/protectedItem/virtualMachines/{id}/deleteManualSnapshots` endpoint
    deletes snapshots created manually for an Azure VM with the specified ID.
