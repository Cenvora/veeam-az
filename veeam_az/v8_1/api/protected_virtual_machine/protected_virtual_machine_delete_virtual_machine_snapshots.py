...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/protectedItem/virtualMachines/{id}/deleteSnapshots".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Remove Snapshots of Protected Azure VM
     ...
     The HTTP POST request to the `/protectedItem/virtualMachines/{id}/deleteSnapshots` endpoint deletes
    snapshots created for an Azure VM with the specified ID.
