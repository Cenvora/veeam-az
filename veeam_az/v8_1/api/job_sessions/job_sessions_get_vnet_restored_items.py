...
from ...models.page_of_vnet_restored_item import PageOfVnetRestoredItem
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/jobSessions/{restore_job_session_id}/vnetRestoredItems".format(
...
) -> PageOfVnetRestoredItem | ProblemDetails401 | ProblemDetails403 | ProblemDetailsTraceId | None:
    if response.status_code == 200:
        response_200 = PageOfVnetRestoredItem.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PageOfVnetRestoredItem | ProblemDetails401 | ProblemDetails403 | ProblemDetailsTraceId]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Virtual Network Configuration Restore Session Data
     ...
     The HTTP GET request to the `/jobSessions/{restoreJobSessionId}/vnetRestoredItems` endpoint
    retrieves a list of Azure resources restored during the virtual network configuration restore
...
def sync(
    ...
    *,
    ...
    Returns:
        PageOfVnetRestoredItem | ProblemDetails401 | ProblemDetails403 | ProblemDetailsTraceId
    """
