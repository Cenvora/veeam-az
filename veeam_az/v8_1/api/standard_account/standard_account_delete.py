...
def sync_detailed(
    ...
    *,
    ...
    """Remove SMTP or Database Account Data
     ...
     The HTTP DELETE request to the `/accounts/standard/{id}` endpoint removes a specific SMTP or
    database account from the Veeam Backup for Microsoft Azure configuration database.
