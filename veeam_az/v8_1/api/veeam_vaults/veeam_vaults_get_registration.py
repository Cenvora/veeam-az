...
def sync_detailed(
    *,
    ...
    """Get Veeam Data Cloud Vault Registration Information
     ...
     The HTTP GET request to the `/veeamVaults/registration` endpoint retrieves information on whether
    your backup appliance is registered in Veeam Data Cloud Vault.
