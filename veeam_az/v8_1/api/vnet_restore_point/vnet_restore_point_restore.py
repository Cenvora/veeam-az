...
from ...models.vnet_restore_options import VnetRestoreOptions
...
def _get_kwargs(
    ...
    *,
    body: VnetRestoreOptions,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/restorePoints/vnets/{restore_point_id}/restore".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Restore Virtual Network Configuration
     ...
     The HTTP POST request to the `/restorePoints/vnets/{restorePointId}/restore` endpoint restores
    virtual network configuration items using the restore point with the specified ID.

    Args:
        restore_point_id (UUID):
        body (VnetRestoreOptions): Specifies Azure network restore options.
