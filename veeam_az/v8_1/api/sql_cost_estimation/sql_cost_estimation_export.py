...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/policies/sql/estimateCost/export",
    }
...
def sync_detailed(
    *,
    ...
    """Export Estimation Cost Report
     ...
     The HTTP POST request to the `/policies/sql/estimateCost/export` endpoint exports the policy cost
    estimation report to a .CSV or an .XML file.
