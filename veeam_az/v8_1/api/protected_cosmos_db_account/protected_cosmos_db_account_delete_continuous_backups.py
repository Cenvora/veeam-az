...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/protectedItem/cosmosDb/{cosmos_db_account_id}/deleteContinuousBackups".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Remove Continuous Backups of Protected Cosmos DB Account
     ...
     The HTTP POST request to the `/protectedItem/cosmosDb/{cosmosDbAccountId}/deleteContinuousBackups`
    endpoint removes from the Veeam Backup for Microsoft Azure configuration database backups created
    using the *Continuous backup* option for a Cosmos DB account with the specified ID.
