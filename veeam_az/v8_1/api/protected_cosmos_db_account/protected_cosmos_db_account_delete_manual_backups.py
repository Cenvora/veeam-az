...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/protectedItem/cosmosDb/{cosmos_db_account_id}/deleteManualBackups".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Remove Manual Backups of Protected Cosmos DB Account
     ...
     The HTTP POST request to the `/protectedItem/cosmosDb/{cosmosDbAccountId}/deleteManualBackups`
    endpoint deletes backups created manually for a Cosmos DB account with the specified ID.
