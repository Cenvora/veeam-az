...
from ...models.identity_provider_is_used_from_client import IdentityProviderIsUsedFromClient
...
def _get_kwargs(
    *,
    body: IdentityProviderIsUsedFromClient,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/settings/saml2/idp/used",
    }
...
def sync_detailed(
    *,
    ...
    """Change Identity Provider URL
     ...
     The HTTP POST request to the `/settings/saml2/idp/used` endpoint allows you to change the identity
