...
def sync_detailed(
    *,
    ...
    """Get Configuration Backup Settings
     ...
     The HTTP GET request to the `/configurationBackup/settings` endpoint retrieves settings configured
    to perform backup of the Veeam Backup for Microsoft Azure configuration database.
