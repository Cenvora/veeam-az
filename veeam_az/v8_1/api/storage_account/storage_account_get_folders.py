...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/cloudInfrastructure/storageAccounts/{azure_storage_id}/containers/{container_name}/folders".format(
...
def sync_detailed(
    ...
    *,
    ...
    `/cloudInfrastructure/storageAccounts/{azureStorageId}/containers/{containerName}/folders` endpoint
    retrieves a list of folders created in a blob container with the specified name.
