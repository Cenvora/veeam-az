...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/policies/cosmosDb/{policy_id}/regions".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Azure Regions Specified in Policy Settings
     ...
     The HTTP GET request to the `/policies/cosmosDb/{policyId}/regions` retrieves a list of Azure
    regions protected by a Cosmos DB backup policy with the specified ID.
