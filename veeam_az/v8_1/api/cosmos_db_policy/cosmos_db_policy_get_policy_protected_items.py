...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/policies/cosmosDb/{policy_id}/protectedItems".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Resources Protected by Backup Policy
     ...
     The HTTP GET request to the `/policies/cosmosDb/{policyId}/protectedItems` endpoint retrieves a list
    of Cosmos DB accounts protected by a backup policy with the specified ID.
