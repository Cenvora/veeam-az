...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/policies/cosmosDb/protectedItems",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Get Collection of Protected Items
     ...
     The HTTP GET request to the `/policies/cosmosDb/protectedItems` endpoint retrieves a list of Cosmos
    DB accounts that are protected by backup policies configured in Veeam Backup for Microsoft Azure.
