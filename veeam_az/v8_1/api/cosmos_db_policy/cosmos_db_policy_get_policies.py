...
from ...models.page_of_cosmos_db_policy import PageOfCosmosDbPolicy
...
) -> PageOfCosmosDbPolicy | ProblemDetails400 | ProblemDetails401 | ProblemDetails403 | None:
    if response.status_code == 200:
        response_200 = PageOfCosmosDbPolicy.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PageOfCosmosDbPolicy | ProblemDetails400 | ProblemDetails401 | ProblemDetails403]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Collection of Cosmos DB Backup Policies
     ...
     The HTTP GET request to the `/policies/cosmosDb` endpoint retrieves a list of Cosmos DB backup
...
def sync(
    *,
    ...
    Returns:
        PageOfCosmosDbPolicy | ProblemDetails400 | ProblemDetails401 | ProblemDetails403
    """
