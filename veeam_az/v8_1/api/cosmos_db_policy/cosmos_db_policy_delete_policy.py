...
def sync_detailed(
    ...
    *,
    ...
    """Remove Backup Policy
     ...
     The HTTP DELETE request to the `/policies/cosmosDb/{policyId}` endpoint deletes a specific Cosmos DB
    backup policy from the Veeam Backup for Microsoft Azure configuration database.
