...
from ...models.sql_manual_backup_settings import SqlManualBackupSettings
from ...types import Response


def _get_kwargs(
    *,
    body: SqlManualBackupSettings,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/databases/startManualBackup",
    }
...
def sync_detailed(
    *,
    ...
    """Create Backups of SQL Databases
     ...
     The HTTP POST request to the `/databases/startManualBackup` endpoint launches a backup operation for
