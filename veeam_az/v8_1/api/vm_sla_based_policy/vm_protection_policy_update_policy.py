...
from ...models.updated_vm_protection_policy_from_client import UpdatedVmProtectionPolicyFromClient
...
def _get_kwargs(
    policy_id: UUID,
    *,
    body: UpdatedVmProtectionPolicyFromClient,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Modify SLA-Based Backup Policy
     ...
     The HTTP PUT request to the `/policy/slaBased/virtualMachines/{policyId}` endpoint updates settings
    of an SLA-based backup policy with the specified ID.
