...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/policy/slaBased/virtualMachines/{policy_id}/regions".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Azure Regions Specified in SLA-Based Backup Policy Settings
     ...
     The HTTP GET request to the `/policy/slaBased/virtualMachines/{policyId}/regions` retrieves a list
    of Azure regions added to the SLA-based backup policy with the specified ID.
