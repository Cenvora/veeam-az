...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/policy/slaBased/virtualMachines/{policy_id}/disable".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Disable SLA-Based Backup Policy
     ...
     The HTTP POST request to the `/policy/slaBased/virtualMachines/{policyId}/disable` endpoint disables
    the enabled SLA-based backup policy with the specified ID.
