...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/policy/slaBased/virtualMachines/protectedItems",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Get Collection of Protected Items
     ...
     The HTTP GET request to the `/policy/slaBased/virtualMachines/protectedItems` endpoint retrieves a
    list of Azure VMs that are protected by SLA-based backup policies configured in Veeam Backup for
    Microsoft Azure.
