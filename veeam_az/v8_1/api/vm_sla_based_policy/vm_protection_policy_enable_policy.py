...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/policy/slaBased/virtualMachines/{policy_id}/enable".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Enable SLA-Based Backup Policy
     ...
     The HTTP POST request to the `/policy/slaBased/virtualMachines/{policyId}/enable` endpoint enables
    the disabled SLA-based backup policy with the specified ID.
