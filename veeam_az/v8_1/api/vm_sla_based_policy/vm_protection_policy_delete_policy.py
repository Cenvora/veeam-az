...
def sync_detailed(
    ...
    *,
    ...
    """Remove SLA-Based Backup Policy
     ...
     The HTTP DELETE request to the `/policy/slaBased/virtualMachines/{policyId}` endpoint removes a
    specific SLA-based backup policy from the Veeam Backup for Microsoft Azure configuration database.
