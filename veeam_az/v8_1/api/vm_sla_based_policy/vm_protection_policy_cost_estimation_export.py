...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/policy/slaBased/virtualMachines/estimateCost/export",
    }
...
def sync_detailed(
    *,
    ...
    """Export Estimation Cost Report
     ...
     The HTTP POST request to the `/policy/slaBased/virtualMachines/estimateCost/export` endpoint exports
    the estimation cost report to a .CSV or an .XML file.
