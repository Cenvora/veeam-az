...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/policy/slaBased/virtualMachines/orderPriorities",
    }
...
def sync_detailed(
    *,
    ...
    """Set SLA-Based Backup Policy Priority
     ...
     The HTTP POST request to the `/policy/slaBased/virtualMachines/orderPriorities` endpoint sets the
    priority order for SLA-based backup policies.

    Args:
        body (list[UUID] | None | Unset): Specifies the priority order for SLA-based backup
            policies.
