...
from ...models.page_of_virtual_machine import PageOfVirtualMachine
...
def _get_kwargs(
    *,
    ...
    json_resource_group_id: None | str | Unset
    if isinstance(resource_group_id, Unset):
        json_resource_group_id = UNSET
    else:
        json_resource_group_id = resource_group_id
    params["ResourceGroupId"] = json_resource_group_id
    ...
    json_exists_state: str | Unset = UNSET
    if not isinstance(exists_state, Unset):
        json_exists_state = exists_state.value

    params["ExistsState"] = json_exists_state

    json_vm_from_protected_regions: bool | None | Unset
    if isinstance(vm_from_protected_regions, Unset):
        json_vm_from_protected_regions = UNSET
    else:
        json_vm_from_protected_regions = vm_from_protected_regions
    params["VmFromProtectedRegions"] = json_vm_from_protected_regions

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/virtualMachines",
        "params": params,
    }
...
) -> PageOfVirtualMachine | ProblemDetails400 | ProblemDetails401 | ProblemDetails403 | None:
    if response.status_code == 200:
        response_200 = PageOfVirtualMachine.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PageOfVirtualMachine | ProblemDetails400 | ProblemDetails401 | ProblemDetails403]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Collection of Azure VMs
     ...
     The HTTP GET request to the `/virtualMachines` endpoint retrieves a list of Azure VMs that can be
...
def sync(
    *,
    ...
    Returns:
        PageOfVirtualMachine | ProblemDetails400 | ProblemDetails401 | ProblemDetails403
    """
