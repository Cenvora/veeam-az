...
from ...models.data_retrieval_extend_options import DataRetrievalExtendOptions
...
def _get_kwargs(
    ...
    *,
    body: DataRetrievalExtendOptions,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/restorePoints/cosmosDb/repository/{restore_point_id}/extendRetrievedDataAvailability".format(
...
def sync_detailed(
    ...
    *,
    ...
    `/restorePoints/cosmosDb/repository/{restorePointId}/extendRetrievedDataAvailability` endpoint
    extends the data availability period of a retrieved restore point with the specified ID.
