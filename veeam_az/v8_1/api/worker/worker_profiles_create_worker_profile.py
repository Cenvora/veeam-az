...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = WorkerProfile.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    ProblemDetails400 | ProblemDetails401 | ProblemDetails403 | ProblemDetails409 | ProblemDetails415 | WorkerProfile
]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ProblemDetails400 | ProblemDetails401 | ProblemDetails403 | ProblemDetails409 | ProblemDetails415 | WorkerProfile]
    """
