...
from ...models.async_operation_of_page_of_tag import AsyncOperationOfPageOfTag
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/cloudInfrastructure/tags",
        "params": params,
    }
...
) -> AsyncOperationOfPageOfTag | PageOfTag | ProblemDetails400 | ProblemDetails401 | ProblemDetails403 | None:
    if response.status_code == 200:
        response_200 = PageOfTag.from_dict(response.json())

        return response_200

    if response.status_code == 202:
        response_202 = AsyncOperationOfPageOfTag.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AsyncOperationOfPageOfTag | PageOfTag | ProblemDetails400 | ProblemDetails401 | ProblemDetails403]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Collection of Azure Tags
     ...
     The HTTP GET request to the `/cloudInfrastructure/tags` endpoint retrieves a list of all Azure tags
    assigned to Azure resources to which Veeam Backup for Microsoft Azure has permissions.
...
def sync(
    *,
    ...
    Returns:
        AsyncOperationOfPageOfTag | PageOfTag | ProblemDetails400 | ProblemDetails401 | ProblemDetails403
    """
