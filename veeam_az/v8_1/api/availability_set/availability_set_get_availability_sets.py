...
from ...models.page_of_availability_set import PageOfAvailabilitySet
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/cloudInfrastructure/availabilitySets",
        "params": params,
    }
...
) -> PageOfAvailabilitySet | ProblemDetails400 | ProblemDetails401 | ProblemDetails403 | None:
    if response.status_code == 200:
        response_200 = PageOfAvailabilitySet.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PageOfAvailabilitySet | ProblemDetails400 | ProblemDetails401 | ProblemDetails403]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Collection of Availability Sets
     ...
     The HTTP GET request to the `/cloudInfrastructure/availabilitySets` endpoint retrieves a list of
    configured availability sets.
...
def sync(
    *,
    ...
    Returns:
        PageOfAvailabilitySet | ProblemDetails400 | ProblemDetails401 | ProblemDetails403
    """
