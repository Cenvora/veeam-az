...
def sync_detailed(
    ...
    *,
    ...
    """Remove Backup Policy
     ...
     The HTTP DELETE request to the `/policies/virtualMachines/{policyId}`endpoint removes a specific
    Azure VM schedule-based backup policy from the Veeam Backup for Microsoft Azure configuration
    database.
