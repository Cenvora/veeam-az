...
from ...models.updated_policy_from_client import UpdatedPolicyFromClient
...
def sync_detailed(
    ...
    *,
    ...
    """Modify Backup Policy
     ...
     The HTTP PUT request to the `/policies/virtualMachines/{policyId}` endpoint updates settings of an
