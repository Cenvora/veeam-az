...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/policies/virtualMachines/{policy_id}/disable".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Disable Backup Policy
     ...
     The HTTP POST request to the `/policies/virtualMachines/{policyId}/disable` endpoint disables an
    enabled Azure VM schedule-based backup policy with the specified ID.
