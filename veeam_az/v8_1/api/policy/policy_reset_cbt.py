...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/policies/virtualMachines/{policy_id}/resetCbt".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Resets Backup Policy CBT
     ...
     The HTTP POST request to the `/policies/virtualMachines/{policyId}/resetCbt` endpoint resets the
    changed block tracking (CBT) mechanism for the Azure VM schedule-based backup policy with the
    specified ID.
