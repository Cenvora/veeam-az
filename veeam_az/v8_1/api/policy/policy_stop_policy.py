...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v8.1/policies/virtualMachines/{policy_id}/stop".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Stop Backup Policy
     ...
     The HTTP POST request to the `/policies/virtualMachines/{policyId}/stop` endpoint stops execution of
    an Azure VM schedule-based backup policy with the specified ID.
