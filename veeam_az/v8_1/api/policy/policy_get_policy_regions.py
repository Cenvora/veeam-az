...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v8.1/policies/virtualMachines/{policy_id}/regions".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Azure Regions Specified in Policy Settings
     ...
     The HTTP GET request to the `/policies/virtualMachines/{policyId}/regions` retrieves a list of Azure
    regions added to an Azure VM schedule-based backup policy with the specified ID.
